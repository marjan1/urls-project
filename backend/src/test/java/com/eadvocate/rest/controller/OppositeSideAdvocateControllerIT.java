...
@ActiveProfiles("dev")
public class OppositeSideAdvocateControllerIT {
    ...
    @Test
    public void shouldAddNewOppositeSideAdvocateSuccessfully() throws Exception {

        String authTokenContent = registrateAndLoginUser(1);

        OppositeSideAdvocateDto requestDto = new OppositeSideAdvocateDto();
        requestDto.setAddress("add");
        requestDto.setEmail("mas@dsd.com");
        requestDto.setName("name23");
        requestDto.setPhone("321344");
        requestDto.setSurname("surNad");


        MvcResult mvcResult = mvc.perform(post("/api/osa/add")
        ...
        OppositeSideAdvocateDto resultObject = objectMapper.readValue(resultAsString, OppositeSideAdvocateDto.class);
