...
@ActiveProfiles("dev")
public class OppositeSidePersonControllerIT {
    ...
    @Test
    public void shouldAddNewOppositeSidePersonSuccessfully() throws Exception {

        String authTokenContent = registrateAndLoginUser(1);

        OppositeSidePersonDto requestDto = new OppositeSidePersonDto();
        requestDto.setAddress("add");
        requestDto.setEmail("mas@dsd.com");
        requestDto.setName("name23");
        requestDto.setPhone("321344");
        requestDto.setEmbg("edbb23");

        MvcResult mvcResult = mvc.perform(post("/api/osp/add")
        ...
        OppositeSidePersonDto resultObject = objectMapper.readValue(resultAsString, OppositeSidePersonDto.class);
        ...
        assertEquals(requestDto.getEmbg(), resultObject.getEmbg());
